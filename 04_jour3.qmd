...
Les 2 plugins utilisés amènent à deux façons de tagger, cela se voit avec la représentation
graphique utilisé dans JOSM.
...
Après avoir fait une premier itinéraire, on modifie notamment les *barrier=gate* en ajoutant
et *locked=yes*, on regarde si cela génère autre chose
