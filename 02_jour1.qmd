...
Au cours des 3 jours, il va falloir manipuler plusieurs données M2 / M3. Une carte présentant les données à analyser sera demandée à la fin de cette journée.
...
Il existe une 3e primitive, plus difficile à utiliser, la relation. Elle est utilisée pour construire les itinéraires de bus par exemple. Elle ne sera pas utilisée dans le cadre
de ce cours.
