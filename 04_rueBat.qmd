...
```{r}
library(sf)
bv <- st_read("data/bondy.gpkg", "bureaudevoteinseereuopenstreetmap__bureauBondy")
st_layers("data/socle.gpkg")
rue <- st_read("data/socle.gpkg", "rue2023__rue")
...
st_write(inter, "data/bondy.gpkg", "rueParBureau", delete_layer = T)
```
...
```{r}
st_layers("data/socle.gpkg")
poi <- st_read("data/socle.gpkg", "tout_poi")
