...
- intégrer deux couches dans Qgis : un fichier forme et un fichier texte
...
Sur différentes échelles (région île de france, région pays de la loire, france)
...
celle de Boigneville (name=arvalis), et à la Jaillère (name=Arvalis)
