...
- start_date (année de construction)
...
Il est intéressant de simplifier le fichier RPLS en supprimant des colonnes et en appliquant un filtre sur les résidences à saisir.
...
- tagger building:owner sur un polygone qui n'est pas un bâtiment n'est pas très malin...
