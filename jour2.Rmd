...
Nous avons 3 types d'objets à traiter :

- la vérification du taggage du bureau de vote

- le périmétre du bureau de vote
...
On sélectionne le secteur, et on fusionne sur le calque d'OSM (menu édition, fusionner la sélection)
...
Mais, aucun champs attributaire concernant le numéro de bureau.
...
Manque de clarté de l'objectif, processus trop longs
Trop de données superposées (filtre d'exclusion -boundary)
