...
::: callout-tip
compétences Qgis : - style gradué sur l'indicateur aire / périmètre avec utilisation de l'histogramme dans la boite de dialogue Voir aussi - outils de traitement = *histogramme* (enregistrer en .png pour le remettre dans la mise en page) ![](img/pngHisto.png)
:::
